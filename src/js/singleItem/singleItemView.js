//Рендерим разметку карточки на отдельной странице
export function render(object, isFaved) {
    ...
    floors_total: "16"
    id: "3"
    image: "http://jsproject.webcademy.ru/images/data/03.png"
    price_sq_m: "72000"
    price_total: "4680000"
    rooms: "3"
    scu: "ЛЕС-09"
...
<div class="container" p-0>
    ...
    //Разметка для модального окна, которое появляется  при клике на кнопку "Забронировать"
...
//Открытие модального окна, которое появляется  при клике на кнопку  "Забронировать" (Удаляем у него класс display:none, изначально разметка модального окна есть на странице отдельной карточки, но она скрыта)
